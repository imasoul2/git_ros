...
* All image processing and face recognition functionalities are provided by utilizing the Shervin Emami's c++ source code for face 
nition (http://www.shervinemami.info/faceRecognition.html). Face Recognition is performed using Eigenfaces (also called "Principal Component Analysis" or PCA)
...
public:
    ...
    as_(nh_, name, boost::bind(&FaceRecognition::executeCB, this, _1), false)
  {
    ...
    pnh_.param<int>("add_face_number", add_face_number, 100);
    add_face_number = 100;
    ...
    image_sub_ = it_.subscribe("/cameras/left_hand_camera/image", 1, &FaceRecognition::imageCB, this);
  }
...
protected:
  ...
  int face_detected ; // this counts how many frames a face has been detected
  int face_recognized; // this counts how many frames a face has been recognized
};


int main(int argc, char** argv)
{
  if( remove( "/home/cjsurface/ros_ws/src/procrob_functional/facedata.xml" ) != 0 )
