...
Download two folders from /JFC_Baxter/Final_Integration:
procrob_functional AND movement_baxter.

Run the program:
1.	Go to the ros workspace and compile the existing packages:
 
2.	Run the arm motion server:
$ roslaunch baxter_movement movementService_launch.launch
3.	Run the face_recognition package:
      $  roslaunch face_recognition face_rec.launch

Reset the data for facial recognition:
1.	Go to “procrob_functional” folder, delete “data” folder and “train.txt” and “facedata.xml”
2.	Go to “Reset data” folder, and copy “data” folder and train.txt and facedata.xml
3.	Paste those into procrob_functional folder

 This is a recommended procedure if the user wishes to reset the face training data. Note that with more data, the slower the training and updating the database will become.


 
 
 
 The ReadMe file of the original package used for facial recognition is shown below; 
